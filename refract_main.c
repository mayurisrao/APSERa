...
int main()
{
  ...
  printf("Enter the source elevation in degrees to be corrected for refraction\n");
  scanf("%lf",&elevation);
  ...
  new_elevation = refraction(elevation, altitude);
	new_elevation *= 180.0/PI;
  printf("elevation = %g, \tnew_elevation = %g\n",elevation*180.0/PI,new_elevation);
  return 0;
}
