...
#define NUMBER_OF_CHANNELS 301 /* 301 to give a 3.0 GHz bandwidth */
#define START_FREQUENCY 3.0 /* 3.0 GHz */
#define INTEGRATION_TIME 60.0 /* sec 	This is the UT time interval in which
												spectra are written out */

#define NOISE_INT_TIME 2.7e10/* 		2.7e10 from equation 4 in draft v25 for 3 sigma det		(256 elements x 1a years) = 8e9 sec			
												This is the time used for computation
												of noise added to the spectrum ... using time for just over 3 sigma*/ 

#define	SITE_LATITUDE  -23.0228//+13.01333 /* deg */
#define	SITE_LONGITUDE -67.7550//77.580833 /* deg */
#define site_altitude 4800//200.0 /* meters */
#define NHPIX 786432
#define PI 3.14159265358979
#define NN 5000 // length of array containing recombination line spectra

#define Trx 14.0 // K 
#define T_atm 1.0 //K ( atmospheric correction - increase on including absorption and translating T_sys (Trx + atmosphere) to above atmosphere)
#define TCMB 2.72548
...
main()
{
  ...
  static const char filename_rec[]= "../data/all_sky_txt/HI.HeI.HeII.dat";
...
*/
  ...
  float yf;
  int npoints1;
  static const char filename6[]="spec_24hwaterfall_chajnantor_00hrs_2pt7e10.txt";
